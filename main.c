/*
Author: Randall Dickinson              Date Completed: 01.27.22
...
int main(void) //the starting point of the program
{
	...
	float y2 = 0.0, distance6 = 0.0, z = 0.0, x = 0.0, general_equation = 0.0;
	//22 variable declarations for precision calculations

	int offset = 0, a = 0; //2 variable declarations for use in equations 3 and 7
	...
	printf("\nThe force of the object is %.2f Newtons\n", force1);
    ...
    printf("\nThe volume of the cylinder is %f cubic meters\n", volume);
	...
	general_equation = ((double)89 / (double)27) - (z * x) + (a / (a % 2));
	printf("\nThe result of the equation is %f\n", general_equation);
